...
export default function Track(track) {
  return (
    <div className="flex flex-row pb-4 space-x-4 items-center border-b border-gray-100 dark:border-gray-800 max-w-3xl w-full mt-8">
      <p className="text-xl font-bold text-gray-400 dark:text-gray-600">
        {track.ranking}
      </p>
      <div >
        <img src={track.albumImageUrl} height={100} width={100} />
      </div>
